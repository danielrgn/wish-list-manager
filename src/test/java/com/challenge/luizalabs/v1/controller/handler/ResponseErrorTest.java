...
public class ResponseErrorTest {
  ...
  @Before
  public void setUp() {
    this.pojoClasses.add(PojoClassFactory.getPojoClass(ResponseError.class));
    this.pojoClasses.add(PojoClassFactory.getPojoClass(ResponseError.ErrorMessage.class));
  }
